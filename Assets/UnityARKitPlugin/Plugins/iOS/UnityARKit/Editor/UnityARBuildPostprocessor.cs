...
public class UnityARBuildPostprocessor
{
    ...
    Directory.CreateDirectory(System.IO.Path.Combine(pathToBuiltProject, "Libraries/Unity"));
		...
		{
      var srcPath = System.IO.Path.Combine("../PluginSource/source", filesToCopy[i]);
			var dstLocalPath = "Libraries/" + filesToCopy[i];
      var dstPath = System.IO.Path.Combine(pathToBuiltProject, dstLocalPath);
